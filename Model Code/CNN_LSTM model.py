...
from tensorflow.keras.layers import Input, Bidirectional, LSTM, Dense, Attention, GlobalAveragePooling1D
...
bi_lstm = Bidirectional(LSTM(256, return_sequences=True))(pool2)
...
cnn_lstm_model = Model(inputs=input_layer, outputs=output_layer, name='cnn_lstm')

cnn_lstm_model.compile(optimizer='adam', loss='categorical_crossentropy', metrics=['accuracy'])

cnn_lstm_model.summary()

cnn_lstm_model.fit(X_train, y_train, validation_data=(X_val, y_val), epochs=8, batch_size=32)

cnn_lstm_model.save('../CNN_LSTM_final/cnn_lstm_rec_100.h5')
